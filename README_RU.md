...
1. Распакуйте готовую сборку PC Remote.
2. Запустите `PC Remote.exe`.
3. Откройте окно подключения по QR-коду через иконку приложения в трее.
4. Отсканируйте QR-код телефоном, подключённым к той же локальной сети.
