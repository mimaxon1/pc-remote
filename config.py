...
PUBLIC_HOST = (os.environ.get("PC_REMOTE_PUBLIC_HOST") or "").strip()
...
WEB_OFFLINE_RETRY_MIN_MS = _env_int(
    "PC_REMOTE_WEB_OFFLINE_RETRY_MIN_MS",
    max(WEB_STATUS_POLL_MS, 4000),
)
WEB_OFFLINE_RETRY_MAX_MS = _env_int("PC_REMOTE_WEB_OFFLINE_RETRY_MAX_MS", 30000)
PAIR_STATUS_POLL_MS = _env_int("PC_REMOTE_PAIR_STATUS_POLL_MS", 700)
TK_QUEUE_POLL_MS = _env_int("PC_REMOTE_TK_QUEUE_POLL_MS", 80)
_SYSTEM_INFO_RUNTIME_TTL_DEFAULT = _env_float("PC_REMOTE_SYSTEM_INFO_CACHE_TTL", 1.0)
SYSTEM_INFO_RUNTIME_TTL_SECONDS = _env_float("PC_REMOTE_SYSTEM_INFO_RUNTIME_TTL", _SYSTEM_INFO_RUNTIME_TTL_DEFAULT)
SYSTEM_INFO_BATTERY_TTL_SECONDS = _env_float("PC_REMOTE_SYSTEM_INFO_BATTERY_TTL", 5.0)
SYSTEM_INFO_NETWORK_TTL_SECONDS = _env_float("PC_REMOTE_SYSTEM_INFO_NETWORK_TTL", 30.0)
SYSTEM_INFO_AUDIO_TTL_SECONDS = _env_float("PC_REMOTE_SYSTEM_INFO_AUDIO_TTL", 10.0)
SYSTEM_INFO_SAMPLE_INTERVAL_SECONDS = _env_float("PC_REMOTE_SYSTEM_INFO_SAMPLE_INTERVAL", 1.0)
SYSTEM_INFO_CACHE_TTL_SECONDS = SYSTEM_INFO_RUNTIME_TTL_SECONDS
